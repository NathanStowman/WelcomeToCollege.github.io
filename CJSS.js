...
(function (window) {
    ...
    function CJSS() {
        ...
        _CJSS.createDropButton = function (b) {
            ...
            b.showing = b.showing == null ? false : b.showing;

            var dropList = new createjs.Container();
            b.dropList = dropList;


            dropList.toggleDropButtons = function () {
            ...
            dropList.hideDropButtons = function () {
                for (var i = 1; i < dropList.numChildren; i++) {
                    dropList.getChildAt(i).visible = false;
                }

                if (update) stage.update();
            }

            dropList.showDropButtons = function () {
                for (var i = 1; i < dropList.numChildren; i++) {
                    dropList.getChildAt(i).visible = true;
                }

                if (update) stage.update();
            }

            dropList.getData = function(){
                return b;
            }

            dropList.hideMainButton = function () {
                mainButton.visible = false;
            }

            dropList.showMainButton = function () {
                mainButton.visible = true;
            }
            

            var mainButton = b.mainButton.changeAction(dropList.toggleDropButtons);
